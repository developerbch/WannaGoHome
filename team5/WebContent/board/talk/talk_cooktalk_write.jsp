    ...
    <form name="myform" id="myform" method="post" action="/talk/insert.html" onSubmit="return doSubmit()">
        ...
        <div class="cs_write">
			...
			<div>
				...
				<input type="hidden" name="video_src" id="video_src" value="">
				<textarea name="video_url" id="video_url" class="form-control step_cont" prev_url="" placeholder="동영상이 있으면 주소를 입력하세요.(Youtube,네이버tvcast,다음tvpot 만 가능) 예)http://youtu.be/lA0Bxo3IZmM" style="height:100px; width:650px; resize:none;"></textarea>
                <div id="divVideoPhotoBox" is_over="0" style="display:inline-block;margin-left:10px;">
				...
				<div style="margin:0 0 17px 17px;">
					<a href="http://www.10000recipe.com/customer/list.html?bid=2&seq=1362" target="_blank">· 동영상 주소(URL) 가져오는 방법 안내</a>
				</div>
			</div>
