  ...
  <div class="modal-dialog" style="width:570px">
	...
	<div class="my_tabs">
	    <ul class="nav nav-tabs nav-justified" style="position:relative;">
	        ...
	        <li role="presentation" class="active"><a href="myhome_comment.jsp"><span class="glyphicon glyphicon-comment"></span>댓글</a></li>
...
.thumbs_hb img {position: absolute;left:50%;top: 50%;width: 100%; height:auto;
  -webkit-transform: translate(-50%,-50%);-ms-transform: translate(-50%,-50%);transform: translate(-50%,-50%);}
        ...
        <dt class="home_cont_tab st2">
            <a href="myhome_comment_receive.jsp" class="tab_mn active">받은 댓글</a>
            <a href="myhome_comment.jsp" class="tab_mn">내가 쓴 댓글</a>
        </dt>
        <div class="brand_cont mag_t_10">
            <ul class="cont_list st3 st3_1">
    <div class="result_none"><img src="http://recipe1.ezmember.co.kr/img/none_talk.png">
    <p>받은 댓글이 없습니다.</p>
    질문이나 의견이 달리면 답글을 남겨주세요.<br>
